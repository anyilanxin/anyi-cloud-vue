      ...
      <ul :class="`${prefixCls}-module`">
        ...
        >
          ...
          <Icon
            ...
            v-if="item.meta && item.meta.icon && (!item.iconType || item.iconType == 0)"
            :icon="item.icon || (item.meta && item.meta.icon)"
          />
          <a-image
            v-else-if="item.meta && item.meta.icon && item.iconType == 1"
            :width="getCollapsed ? '16px' : '20px'"
            :height="getCollapsed ? '16px' : '20px'"
            :src="item.meta.icon"
          />
          <span
            v-else-if="(!item.meta || !item.meta.icon) && getCollapsed"
            style="
              padding-left: 6px;
              margin-right: 5px;
              width: 45px;
